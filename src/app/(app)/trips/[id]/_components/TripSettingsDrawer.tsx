...
import {
  ...
  Image as ImageIcon, Calendar, Save, UserPlus,
} from 'lucide-react';
import { Trip, tripsApi, EnabledModules } from '@/lib/api/trips.api';
...
export function TripSettingsDrawer({ trip, token, isOwner, onClose }: Props) {
  ...
  return (
    ...
    <div className="fixed inset-0 z-[60] vs-modal-overlay">
      ...
      <aside
        role="dialog"
        aria-label="行程設定"
        className="relative w-full max-w-md bg-white rounded-t-2xl sm:rounded-2xl shadow-2xl shadow-slate-900/20 border border-slate-100 flex flex-col vs-modal-dialog overflow-y-auto"
